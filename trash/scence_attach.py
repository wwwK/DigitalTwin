...
class MoveItDemo:
    def __init__(self):
        ...
        box2_size = [ 0.10*42/35,0.60*42/35, 0.40*42/35]
        ...
        box1_pose.pose.position.y = 0.30*42/35
        box1_pose.pose.position.z = 0.5*42/35
	...
	#将立方体加到规划场景中
        ...
        box2_pose.pose.position.y = 0.30*42/35
        box2_pose.pose.position.z = 0.20*42/35+0.09*42/35
	...
	#-0.185        
	box3_pose.pose.position.x = 0.30*42/35
        box3_pose.pose.position.y = 0.30*42/35
        box3_pose.pose.position.z = 0.25*42/35
	...
	self.setColor(box3_id, 0.8, 0.4, 0, 1.0)
