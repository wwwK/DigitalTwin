...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.InfoSet = QtWidgets.QPushButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setFamily("Adobe Arabic")
        font.setPointSize(20)
        self.InfoSet.setFont(font)
        self.InfoSet.setObjectName("InfoSet")
        self.gridLayout.addWidget(self.InfoSet, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.WeldingMethodPredict, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.portReceive, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.InfoSet.setText(_translate("MainWindow", "初始信息设置"))
        self.WeldingMethodPredict.setText(_translate("MainWindow", "智能预测"))
